...
for(i in 6:10){
  file_name = paste0("Results_Combination42.",i,".RData")
  ...
  total_area = sum(item_area)
  prop = total_area/(200*200)
  cost_lb = 100 * prop
  print(round(cost_lb,2))
}  
...
plot(test$load_imbalance_eval, type = "l")
plot(test$cost_eval, type = "l")
...
plot(test_eval_cost_50~test_eval_load_imbalance_50, pch = 16, cex = 1.2, col = "red", 
  xlim=c(0,5000), ylim = c(0,15000), xlab = "Load Imbalance",
...
plot(test_eval_cost_500~test_eval_load_imbalance_500)
